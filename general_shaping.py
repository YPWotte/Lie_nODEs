...
# <h1> Only General Potential Shaping: gradients immediately on algebra, potential on SE(3) </h1>
...
from models import se3_Dynamics,SE3_Dynamics, SE3_Quadratic, AugmentedSE3, PosDefSym, PosDefTriv, PosDefSym_Small, Quadratic_Potential_SE3
...
# Integral Loss
integral_loss_scale = torch.tensor(1).to(device)
...
### Initialize Dynamics 
#(I,B,V) = torch.load('IBV_fShaping_15_06_14:37.pt') #('IBV_fShaping_19_09_16:25.pt')
...
solver = 'dopri5'
atol, rtol, atol_adjoint, rtol_adjoint = 1e-6,1e-7,1e-6,1e-7
