...
FOLDER = []
NAME_IBV = ['quadratic_13_10_11:04']#['quadratic_26_07_10:33', 'A_01_09_16:46','A_18_08_12:09','04_08_10:57','21_07_10:07']
H_Target_23 = [0]#[0,-1,-2,0,0]
DUPPER = [1]#[1,3,3,1,1]
...
FOLDER = ['Quadratic_NN_13-10']#['General_NN_20-07_to_NN_01-09', 'Quadratic_NN_25-07_to_NN_27-07']
#folder = FOLDER[1]
#NAME1 = ['NN_01-09_16:46', 'NN_04-08_10:57', 'NN_07-08_17:16', 'NN_18-08_12:09']#, 'NN_20-07_16:50', 'NN_21-07_10:07']
#NAME2 = ['NN_27-07_11:03']
NAME3 = ['NN_13-10_11:04']
NAMENAME = [NAME3]#[NAME1,NAME2]
#STORENAME1 = ['A_01_09_16:46','04_08_10:57','NN_07-08_17:16', 'NN_18-08_12:09']
#STORENAME2 = ['quadratic_26_07_10:33']
STORENAME3 = ['quadratic_13-10_11:04']
STORENAME = [STORENAME3] #[STORENAME1,STORENAME2]
...
# 
# for name1,name2,folder in zip (NAME1,NAME2,FOLDER):
...
#     plt.title(title)
#     plt.tight_layout()
#     plt.savefig('./Results/Figures/'+name1+'/Loss_'+name1+'.svg')
#     
#     
...
#     plt.title(title)
#     plt.tight_layout()
#     plt.savefig('./Results/Figures/'+name1+'/Angle_'+name1+'.svg')
#     
#     
#     ## plot state data: distance
#     plt.style.use("./mystyle2.txt")
...
#     plt.title(title)
#     plt.tight_layout()
#     plt.savefig('./Results/Figures/'+name1+'/Distance_'+name1+'.svg')
#     
#     
#     ## plot state data: angular momentum
#     plt.style.use("./mystyle2.txt")
...
#     plt.title(title)
#     plt.tight_layout()
#     plt.savefig('./Results/Figures/'+name1+'/Pw_'+name1+'.svg')
#     
#     
#     
#     ## plot state data
...
#     plt.title(title)
#     plt.tight_layout()
#     plt.savefig('./Results/Figures/'+name1+'/Pv_'+name1+'.svg')
# 
# =============================================================================
