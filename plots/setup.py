...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  1 10:15:53 2023
...
plt.tight_layout()
fig1.savefig('./Results/Figures/Angle_v_Time_3s.svg')
...
plt.tight_layout()
fig2.savefig('./Results/Figures/Dist_v_Time_3s.svg')
...
plt.tight_layout()
fig1.savefig('./Results/Figures/Angle_v_Time_%ds.svg' %5)
...
plt.tight_layout()
fig2.savefig('./Results/Figures/Dist_v_Time_%ds.svg' %5)
...
plt.tight_layout()
fig1.savefig('./Results/Figures/Angle_v_Time_21s.svg')
...
plt.tight_layout()
fig2.savefig('./Results/Figures/Dist_v_Time_21s.svg')
...
plt.title(title)
plt.tight_layout()
plt.savefig('./Results/Figures/Pot_v_Dist.svg')
...
plt.title(title)
plt.tight_layout()
plt.savefig('./Results/Figures/Pot_v_Screw.svg')
...
plt.title(title)
plt.tight_layout()
plt.savefig('./Results/Figures/Pot_v_Ang.svg')
...
plt.title(title)
plt.tight_layout()
plt.savefig('./Results/Figures/Pot_v_Dist_outside_range.svg')
...
plt.title(title)
plt.tight_layout()
plt.savefig('./Results/Figures/3_Pot_v_Dist.svg')
...
plt.title(title)
plt.tight_layout()
plt.savefig('./Results/Figures/Energy_components.svg')
...
plt.title(title)
plt.tight_layout()
plt.savefig('./Results/Figures/Energy_components_normalized.svg')
...
plt.title(title)
plt.tight_layout()
plt.savefig('./Results/Figures/Energy_components_average_cumulative.svg')
...
folder = FOLDER[1]
#NAME = ['NN_01-09_16:46', 'NN_04-08_10:57', 'NN_07-08_17:16', 'NN_18-08_12:09']#, 'NN_20-07_16:50', 'NN_21-07_10:07']
NAME = ['NN_27-07_11:03']
for name in NAME:
    ...
    plt.title(title)
    plt.tight_layout()
    plt.savefig('./Results/Figures/Loss_'+name+'.svg')
    ...
    plt.title(title)
    plt.tight_layout()
    plt.savefig('./Results/Figures/Angle_'+name+'.svg')
    ...
    plt.title(title)
    plt.tight_layout()
    plt.savefig('./Results/Figures/Distance_'+name+'.svg')
    ...
    plt.title(title)
    plt.tight_layout()
    plt.savefig('./Results/Figures/Pw_'+name+'.svg')
    ...
    plt.title(title)
    plt.tight_layout()
    plt.savefig('./Results/Figures/Pv_'+name+'.svg')
...
FOLDER = ['General_NN_20-07_to_NN_01-09', 'Quadratic_NN_25-07_to_NN_27-07']
folder = FOLDER[1]
name1 = 'NN_25-07_13:08' #;'NN_20-07_16:50'#
name2 = 'NN_26-07_10:33' #;'NN_21-07_10:07'#
...
plt.title(title)
plt.tight_layout()
plt.savefig('./Results/Figures/Loss_'+name1+'.svg')
...
plt.title(title)
plt.tight_layout()
plt.savefig('./Results/Figures/Angle_'+name1+'.svg')
...
plt.title(title)
plt.tight_layout()
plt.savefig('./Results/Figures/Distance_'+name1+'.svg')
...
plt.title(title)
plt.tight_layout()
plt.savefig('./Results/Figures/Pw_'+name1+'.svg')
...
plt.title(title)
plt.tight_layout()
plt.savefig('./Results/Figures/Pv_'+name1+'.svg')
